...
public class User extends BaseObject implements Serializable, UserDetails {
    ...
    private Boolean fbLiked;
    private Boolean tweeted;
    private Boolean fbFollow;
	...
	@Column(name = "fbliked")
	public Boolean getFbLiked() {
		return fbLiked;
	}

	public void setFbLiked(Boolean fbLiked) {
		this.fbLiked = fbLiked;
	}
	...
	@Column(name = "fbfollow")
	public Boolean getFbFollow() {
		return fbFollow;
	}

	public void setFbFollow(Boolean fbFollow) {
		this.fbFollow = fbFollow;
	}
