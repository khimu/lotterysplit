         ...
         <div data-role="content">     	
			...
			<div class="ui-grid-a">
                ...
                <div class="ui-block-b">
                	<a data-ajax="false" href="${pageContext.request.contextPath}/lottery/ticket/split.htm" data-role="button">Sell Lottery Ticket</a>                   
                </div>
			</div>   			
						...
						<div class="post-info">						
			        		<div class="post-basic-info">
								<div class="comment_desc">
									...
									<p>
										<button data-inline="true" data-mini="true" data-ajax="false" onclick="window.location.href='${pageContext.request.contextPath}/lottery/ticket/detail/${ticket.lotteryTicketId}';">DETAIL</button>
									</p>
								</div>	
			        		</div>
			        	</div>
	...
	$(function() {
		$("#tickets").paginate({
			...
			onChange     			: function(page){
				window.location.href="${pageContext.request.contextPath}/lottery/ticket/sold.htm?start=" + page;
									  }
		});
	});
	</script>
